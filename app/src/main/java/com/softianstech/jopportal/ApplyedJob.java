...
/**
 * Created by Lenovo on 7/14/2017.
 */

public class ApplyedJob extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        url2 = Links.USER_APPLYEDJOB+Variables.client_email;
    ...
    private void showJSON(String json){
        ...
        CustomList3 cl = new CustomList3(getActivity(), ParseJSON2.ids, ParseJSON2.locations, ParseJSON2.qualifications,ParseJSON2.experiences,ParseJSON2.subjects);
