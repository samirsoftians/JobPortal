...
public class CustomList2 extends ArrayAdapter<String>  {
    ...
    public CustomList2(Activity context, String[] ids, String[] locations, String[] qualifications, String[] experiences,  String[] subjects, String[] useremail) {
...
//        textSubjects.setText(s+subjects[position]);
        ...
        if (useremail[position].equals(Variables.client_email))
        {
           ...
           // textQualification.setText(qualifications[position]+q);
            textExperience.setText(qualifications[position]+q);
            // textDesignation.setText(d+designations[position]);
            textSubjects.setText(s+subjects[position]);
            butapply.setImageBitmap(bitmap1);
        ...
        else
        {
            ...
            textExperience.setText(qualifications[position]+q);
          //  textQualification.setText(qualifications[position]+q);
            //textExperience.setText(experiences[position]);
            // textDesignation.setText(d+designations[position]);
            textSubjects.setText(s+subjects[position]);
